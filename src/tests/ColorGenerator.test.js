...
test('should generate random colors for wordOne and wordTwo', () => {
...
test('should generate random inkColor', () => {
    const randomValue = 0.4; // Set to produce inkColor as wordOne
